...
public class OrganizationTableViewController implements Initializable, 
	...
	public void openOrganizationForm(ActionEvent actionEvent) {
		...
		if(mainMenu != null) {
			mainMenu.loadFxmlAndOpenInTab(StartingPane.FXML_ROOT+"organization_form.fxml", 
	...
	public void newOrganizationForm(ActionEvent actionEvent) {
		MainMenu mainMenu = SessionUtil.retrieveMainMenu(session);
		if(mainMenu != null) {
			mainMenu.loadFxmlAndOpenInTab(StartingPane.FXML_ROOT+"organization_form.fxml", "Новый клиент юр.лицо");
		}
	}
